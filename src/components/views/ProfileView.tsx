...
export default function ProfileView() {
    ...
    return (
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="absolute inset-0 w-full h-full overflow-y-auto no-scrollbar bg-[#F5F4F0] dot-grid pt-safe">
